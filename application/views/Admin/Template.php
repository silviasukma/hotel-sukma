...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?= base_url('_assets/') ?>plugins/summernote/summernote-bs4.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    ...
                    <li class=""><a href="<?= base_url() ?>index.php/Admin/TipeKamar/"><i class="fa fa-link"></i><span>Tipe Kamar</span>
                    <li class=""><a href="<?= base_url() ?>index.php/Admin/FasilitasKamar/"><i class="fa fa-link"></i><span>Fasilitas Kamar</span></a></li>
                    <li class=""><a href="<?= base_url() ?>index.php/Admin/FasilitasHotel/"><i class="fa fa-link"></i><span>Fasilitas Hotel</span></a></li>
                    <li class=""><a href="<?= base_url() ?>index.php/Admin/Kamar/"><i class="fa fa-link"></i><span>Kamar</span></a></li>
                    <li class=""><a href="#"><i class="fa fa-link"></i><span>users</span></a></li>
    ...
    <script src="<?= base_url('_assets/') ?>plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
    <!-- jQuery Knob Chart -->
